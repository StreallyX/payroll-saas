...
interface AuditLogTableProps {
 logs: AuditLog[];
 onViewDandails?: (log: AuditLog) => void;
}

export function AuditLogTable({ logs, onViewDandails }: AuditLogTableProps) {
 ...
 <p className="text-sm tronecate">{log.description}</p>
 </TableCell>
 <TableCell>
 ...
 <DropdownMenuItem onClick={() => onViewDandails?.(log)}>
