...
type StatusVariant = "approved" | "pending" | "rejected" | "paid" | "processing" | "failed" | "draft" | "submitted" | "completed" | "invited" | "hired";
...
const statusConfig: Record<string, { variant: "default" | "secondary" | "destructive" | "outline"; className: string }> = {
  ...
  draft: { variant: "outline", className: "bg-gray-100 text-gray-800 hover:bg-gray-100" },
  invited: { variant: "outline", className: "bg-gray-100 text-gray-800 hover:bg-gray-100" },
