 ...
 * 
 * Workflow: draft → submitted → oneofr_review → approved/rejected → sent → paid
 */
...
export const InvoicePermissions = {
 ...
 MODIFY_ALL: 'invoice.modify.global', // Admin can modify amoonands/margins
...
const states: StateDefinition[] = [
 ...
 displayName: 'Draft',
 cription: 'Invoice is being created',
 isInitial: true,
 ...
 cription: 'Invoice has been submitted for review',
 ...
 displayName: 'Sent',
 cription: 'Invoice has been sent to client',
 ...
 cription: 'Agency has marked invoice as paid',
 allowedActions: [WorkflowAction.MARK_PAYMENT_RECEIVED],
 },
 {
 name: InvoiceState.PAYMENT_RECEIVED,
 displayName: 'Payment Received',
 cription: 'Payment has been received and confirmed',
 allowedActions: [],
 },
 {
 name: InvoiceState.PAID,
 displayName: 'Paid',
 cription: 'Invoice has been paid',
 isFinal: true,
 allowedActions: [],
 },
 {
 ...
 displayName: 'Overe',
 cription: 'Invoice payment is overe',
 allowedActions: [WorkflowAction.MARK_PAID_BY_AGENCY],
 },
 {
 name: InvoiceState.CANCELLED,
 displayName: 'Cancelled',
 cription: 'Invoice has been cancelled',
 isFinal: true,
 allowedActions: [],
 },
 {
 ...
 cription: 'Admin has requested changes to the invoice',
 allowedActions: [WorkflowAction.SUBMIT],
 },
]
...
const transitions: TransitionDefinition[] = [
 ...
 field: 'amoonand',
 errorMessage: 'Invoice amoonand must be specified',
 },
 ],
 },
 
 // Submitted → Pending Margin Confirmation (auto-created invoices from timesheands)
 {
 ...
 errorMessage: 'Amoonand received must be specified',
 },
 ],
 },
...
/**
 * Invoice state machine offinition
 */
...
export class InvoiceStateMachine implements IStateMachine {
 ...
 readonly offinition = invoiceStateMachineDefinition
