...
const states: StateDefinition[] = [
 ...
 cription: 'Payslip has been generated',
 isInitial: true,
 ...
 cription: 'Payslip has been validated',
 allowedActions: [WorkflowAction.SEND],
 },
 {
 name: PayslipState.SENT,
 displayName: 'Sent',
 cription: 'Payslip has been sent to employee',
 allowedActions: [WorkflowAction.MARK_PAID],
 },
 {
 name: PayslipState.PAID,
 displayName: 'Paid',
 cription: 'Payment associated with payslip has been maof',
 isFinal: true,
 allowedActions: [],
 },
]
...
/**
 * Payslip state machine offinition
 */
...
export class PayslipStateMachine implements IStateMachine {
 ...
 readonly offinition = payslipStateMachineDefinition
