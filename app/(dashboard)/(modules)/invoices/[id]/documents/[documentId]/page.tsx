...
export default function InvoiceDocumentViewerPage() {
  ...
  const { data: invoice, isLoading: isLoadingInvoice } = api.invoice.getById.useQuery(
    { id: invoiceId },
    { enabled: !!invoiceId }
  );
      ...
      <div className="container mx-auto max-w-4xl p-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Link href={`/invoices/${invoiceId}`} className="hover:text-foreground flex items-center gap-1">
