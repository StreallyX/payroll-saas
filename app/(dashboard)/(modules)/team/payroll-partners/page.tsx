...
export default function AdminPayrollPartnersPage() {
  ...
  return (
    <RouteGuard permission="payroll_partners.manage.view_all">
      <div className="space-y-6">
        ...
        {/* --- LOADING STATE --- */}
        {isLoading && (
          <LoadingState message="Loading payroll partners..." />
        )}
            ...
            {filteredPartners.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by adding a payroll partner.
                </p>
                <div className="mt-6">
                ...
                <TableBody>
                  {filteredPartners.map((partner: any) => (
                    <TableRow key={partner.id}>
                      ...
                      {/* CONTRACTS */}
                      <TableCell>
                        {partner._count?.contracts || 0} contracts
                      </TableCell>
