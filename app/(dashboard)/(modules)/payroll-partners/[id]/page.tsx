...
// Document type categories for payroll partners
const PAYROLL_PARTNER_DOC_CATEGORIES = [
...
export default function PayrollPartnerDetailPage() {
  ...
  if (!company) {
    return (
      <div className="space-y-6">
        <PageHeader title="Partner Not Found" description="The payroll partner you're looking for doesn't exist." />
        <Button onClick={() => router.push("/payroll-partners")}>
          <ArrowLeft className="h-4 w-4 mr-2" />
          Back to Payroll Partners
        </Button>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={company.name}
        description="View and manage payroll partner details, contacts, and documents"
      >
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => router.push("/payroll-partners")}>
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back
          </Button>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    People associated with this payroll partner
                  </CardDescription>
                </div>
              ...
              {contacts.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Add contacts to manage the people associated with this payroll partner.
                  </p>
                  <div className="mt-4">
                    <Button onClick={() => setIsAddContactOpen(true)}>
                      <UserPlus className="h-4 w-4 mr-2" />
        ...
        <TabsContent value="documents">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Contracts, SOWs, invoices, payslips, and other documents shared with this payroll partner.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DocumentList
                entityType="payroll_partner"
                entityId={companyId}
              />
            </CardContent>
          </Card>
      ...
      <DeleteConfirmDialog
        ...
        description={`Are you sure you want to remove "${contactToRemove?.user?.name}" from this company? They will no longer be associated with this payroll partner.`}
