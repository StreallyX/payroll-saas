        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-yellow-700 mt-1">
              Subscription management is available via the Tenant model, but requires UI implementation for full management.
            </p>
            <p className="text-sm text-yellow-600 mt-2">
              Available: <code className="bg-yellow-100 px-2 py-1 rounded">api.tenant.getSubscriptionInfo</code> and <code className="bg-yellow-100 px-2 py-1 rounded">api.tenant.updateSubscriptionPlan</code>
            </p>
          </div>
        </div>
      </div>
