  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Manage feature flags across all tenants"
      />
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-600 mt-2">
              Note: Individual tenant feature flags can be managed via <code className="bg-yellow-100 px-2 py-1 rounded">api.tenant.getEnabledFeatures</code> and <code className="bg-yellow-100 px-2 py-1 rounded">api.tenant.toggleFeature</code>
            </p>
          </div>
        </div>
      </div>
