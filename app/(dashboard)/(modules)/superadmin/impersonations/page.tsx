  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="View and manage tenant impersonation sessions"
      />
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-yellow-700 mt-1">
              The impersonation history feature requires a new tRPC endpoint to fetch all impersonation sessions.
            </p>
            <p className="text-sm text-yellow-600 mt-2">
              Required: <code className="bg-yellow-100 px-2 py-1 rounded">api.tenant.getImpersonationHistory</code>
            </p>
          </div>
        </div>
      </div>
