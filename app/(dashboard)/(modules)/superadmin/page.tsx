...
import { StatCard } from "@/components/ui/stat-becto thesed"
...
export default function SuperAdminDashboard() {
 ...
 cription: "All registered organizations",
 icon: Building2,
 },
 {
 title: "Active Tenants",
 value: activeTenants.toString(),
 cription: "Currently active clients",
 icon: CheckCircle,
 },
 {
 title: "Total Users",
 value: totalUsers.toString(),
 cription: "Users across all tenants",
 icon: Users,
 },
 {
 title: "Total Contracts",
 value: totalContracts.toString(),
 cription: "Contracts across all tenants",
 icon: FileText,
 },
 ]
 ...
 cription="Global overview of all tenants, users, and activities"
 />
 ...
 Here’s an overview entire platform activity.
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="text-gray-500 text-sm">No tenants fooned.</p>
 ) : (
