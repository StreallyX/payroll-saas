/**
 * Script to ensure PAYROLL role has contract permissions
 * Run with: npx tsx scripts/add-payroll-contract-permissions.ts
 */
...
const PERMISSIONS_TO_ADD = [
  "contract.access.page",
  "contract.read.own",
]

async function main() {
  console.log("Checking contract permissions for PAYROLL role...")
